...
#ifndef CASHTREES_IOS_SWIFT_H
#define CASHTREES_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CashTrees_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class UIWindow;
SWIFT_CLASS("_TtC13CashTrees_iOS20CashTreesAppDelegate")
@interface CashTreesAppDelegate : NSObject <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC13CashTrees_iOS23CashTreesWebCoordinator")
@interface CashTreesWebCoordinator : NSObject <WKNavigationDelegate, WKScriptMessageHandler>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC13CashTrees_iOS31RecoveryQRScannerViewController")
@interface RecoveryQRScannerViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate>
- (void)viewDidLoad;
