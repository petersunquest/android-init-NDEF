...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../common.js"
  ...
  export interface BeamioIndexerDiamond2Interface extends Interface {
  ...
  export interface BeamioIndexerDiamond2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioIndexerDiamond2;
    waitForDeployment(): Promise<this>;

    interface: BeamioIndexerDiamond2Interface;
