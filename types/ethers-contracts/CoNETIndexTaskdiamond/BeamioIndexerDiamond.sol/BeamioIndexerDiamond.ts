...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../common.js"
  ...
  export interface BeamioIndexerDiamondInterface extends Interface {
  ...
  export interface BeamioIndexerDiamond extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioIndexerDiamond;
    waitForDeployment(): Promise<this>;

    interface: BeamioIndexerDiamondInterface;
