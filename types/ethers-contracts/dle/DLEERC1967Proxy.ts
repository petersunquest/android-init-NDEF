...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface DLEERC1967ProxyInterface extends Interface {
  ...
  export interface DLEERC1967Proxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): DLEERC1967Proxy;
    waitForDeployment(): Promise<this>;

    interface: DLEERC1967ProxyInterface;
