...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface INickCreate2Interface extends Interface {
  ...
  export interface INickCreate2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): INickCreate2;
    waitForDeployment(): Promise<this>;

    interface: INickCreate2Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    deploy: TypedContractMethod<
      [initCode: BytesLike, salt: BytesLike, ],
      [string],
      'nonpayable'
    >
