...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface EIP20Permit3009UpgradeableInterface extends Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "AuthorizationUsed" | "EIP712DomainChanged" | "Initialized"): EventFragment;
...
decodeFunctionResult(functionFragment: 'transferWithAuthorization(address,address,uint256,uint256,uint256,bytes32,uint8,bytes32,bytes32)', data: BytesLike): Result;
  ...
  export interface EIP20Permit3009Upgradeable extends BaseContract {
    
    connect(runner?: ContractRunner | null): EIP20Permit3009Upgradeable;
    waitForDeployment(): Promise<this>;

    interface: EIP20Permit3009UpgradeableInterface;
