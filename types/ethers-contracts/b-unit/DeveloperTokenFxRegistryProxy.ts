...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface DeveloperTokenFxRegistryProxyInterface extends Interface {
  ...
  export interface DeveloperTokenFxRegistryProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): DeveloperTokenFxRegistryProxy;
    waitForDeployment(): Promise<this>;

    interface: DeveloperTokenFxRegistryProxyInterface;
