...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ITreasuryAdminERC20Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'mint', data: BytesLike): Result;
  ...
  export interface ITreasuryAdminERC20 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ITreasuryAdminERC20;
    waitForDeployment(): Promise<this>;

    interface: ITreasuryAdminERC20Interface;
