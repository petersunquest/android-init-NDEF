...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface DepinGbSettlement1155ProxyInterface extends Interface {
  ...
  export interface DepinGbSettlement1155Proxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): DepinGbSettlement1155Proxy;
    waitForDeployment(): Promise<this>;

    interface: DepinGbSettlement1155ProxyInterface;
