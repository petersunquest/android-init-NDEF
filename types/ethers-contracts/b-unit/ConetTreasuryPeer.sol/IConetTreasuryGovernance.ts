...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IConetTreasuryGovernanceInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'minerCount', data: BytesLike): Result;
  ...
  export interface IConetTreasuryGovernance extends BaseContract {
    
    connect(runner?: ContractRunner | null): IConetTreasuryGovernance;
    waitForDeployment(): Promise<this>;

    interface: IConetTreasuryGovernanceInterface;
