...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioBUnitsMintInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'mintReward', data: BytesLike): Result;
  ...
  export interface IBeamioBUnitsMint extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioBUnitsMint;
    waitForDeployment(): Promise<this>;

    interface: IBeamioBUnitsMintInterface;
