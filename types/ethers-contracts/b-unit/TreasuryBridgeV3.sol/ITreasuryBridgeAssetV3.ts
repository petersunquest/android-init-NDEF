...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ITreasuryBridgeAssetV3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'mint', data: BytesLike): Result;
  ...
  export interface ITreasuryBridgeAssetV3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ITreasuryBridgeAssetV3;
    waitForDeployment(): Promise<this>;

    interface: ITreasuryBridgeAssetV3Interface;
