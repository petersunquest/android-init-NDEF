...
decodeFunctionResult(functionFragment: 'upgradeToAndCall', data: BytesLike): Result;
  ...
  export interface FactoryERC20Upgradeable extends BaseContract {
    
    connect(runner?: ContractRunner | null): FactoryERC20Upgradeable;
    waitForDeployment(): Promise<this>;

    interface: FactoryERC20UpgradeableInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initialize: TypedContractMethod<
      [name_: string, symbol_: string, decimals_: BigNumberish, minter_: AddressLike, ],
      [void],
      'nonpayable'
    >
