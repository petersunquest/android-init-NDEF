...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioBUnitsBridgeDepositInterface extends Interface {
  ...
  export interface IBeamioBUnitsBridgeDeposit extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioBUnitsBridgeDeposit;
    waitForDeployment(): Promise<this>;

    interface: IBeamioBUnitsBridgeDepositInterface;
