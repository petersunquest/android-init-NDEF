...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IConetGB1155DepositInterface extends Interface {
    getFunction(nameOrSignature: "issueGB"): FunctionFragment;
  ...
  export interface IConetGB1155Deposit extends BaseContract {
    
    connect(runner?: ContractRunner | null): IConetGB1155Deposit;
    waitForDeployment(): Promise<this>;

    interface: IConetGB1155DepositInterface;
