...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IERC3009VRSInterface extends Interface {
  ...
  export interface IERC3009VRS extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC3009VRS;
    waitForDeployment(): Promise<this>;

    interface: IERC3009VRSInterface;
