...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioQuoteHelperInterface extends Interface {
  ...
  export interface IBeamioQuoteHelper extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioQuoteHelper;
    waitForDeployment(): Promise<this>;

    interface: IBeamioQuoteHelperInterface;
