...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IConetTreasuryInterface extends Interface {
  ...
  export interface IConetTreasury extends BaseContract {
    
    connect(runner?: ContractRunner | null): IConetTreasury;
    waitForDeployment(): Promise<this>;

    interface: IConetTreasuryInterface;
