...
export declare namespace IActionFacet {
    ...
    export type TransactionInputStruct = {txId: BytesLike, originalPaymentHash: BytesLike, chainId: BigNumberish, txCategory: BytesLike, displayJson: string, timestamp: BigNumberish, payer: AddressLike, payee: AddressLike, finalRequestAmountFiat6: BigNumberish, finalRequestAmountUSDC6: BigNumberish, isAAAccount: boolean, route: IActionFacet.RouteItemInputStruct[], fees: IActionFacet.FeeInfoInputStruct, meta: IActionFacet.TransactionMetaInputStruct, operator: AddressLike, operatorParentChain: AddressLike[]}

    export type TransactionInputStructOutput = [txId: string, originalPaymentHash: string, chainId: bigint, txCategory: string, displayJson: string, timestamp: bigint, payer: string, payee: string, finalRequestAmountFiat6: bigint, finalRequestAmountUSDC6: bigint, isAAAccount: boolean, route: IActionFacet.RouteItemInputStructOutput[], fees: IActionFacet.FeeInfoInputStructOutput, meta: IActionFacet.TransactionMetaInputStructOutput, operator: string, operatorParentChain: string[]] & {txId: string, originalPaymentHash: string, chainId: bigint, txCategory: string, displayJson: string, timestamp: bigint, payer: string, payee: string, finalRequestAmountFiat6: bigint, finalRequestAmountUSDC6: bigint, isAAAccount: boolean, route: IActionFacet.RouteItemInputStructOutput[], fees: IActionFacet.FeeInfoInputStructOutput, meta: IActionFacet.TransactionMetaInputStructOutput, operator: string, operatorParentChain: string[] }
