...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface BeamioConsumerWalletDashboardProxyInterface extends Interface {
  ...
  export interface BeamioConsumerWalletDashboardProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioConsumerWalletDashboardProxy;
    waitForDeployment(): Promise<this>;

    interface: BeamioConsumerWalletDashboardProxyInterface;
