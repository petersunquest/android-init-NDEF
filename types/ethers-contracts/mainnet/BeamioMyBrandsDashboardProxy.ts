...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface BeamioMyBrandsDashboardProxyInterface extends Interface {
  ...
  export interface BeamioMyBrandsDashboardProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioMyBrandsDashboardProxy;
    waitForDeployment(): Promise<this>;

    interface: BeamioMyBrandsDashboardProxyInterface;
