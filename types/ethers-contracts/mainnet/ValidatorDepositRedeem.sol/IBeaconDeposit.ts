...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeaconDepositInterface extends Interface {
  ...
  export interface IBeaconDeposit extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeaconDeposit;
    waitForDeployment(): Promise<this>;

    interface: IBeaconDepositInterface;
