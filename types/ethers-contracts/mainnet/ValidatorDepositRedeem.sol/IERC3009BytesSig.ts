...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IERC3009BytesSigInterface extends Interface {
  ...
  export interface IERC3009BytesSig extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC3009BytesSig;
    waitForDeployment(): Promise<this>;

    interface: IERC3009BytesSigInterface;
