...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IERC1155BalanceInterface extends Interface {
  ...
  export interface IERC1155Balance extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC1155Balance;
    waitForDeployment(): Promise<this>;

    interface: IERC1155BalanceInterface;
