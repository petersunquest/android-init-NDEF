...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface ChatIndexRegistryProxyInterface extends Interface {
  ...
  export interface ChatIndexRegistryProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): ChatIndexRegistryProxy;
    waitForDeployment(): Promise<this>;

    interface: ChatIndexRegistryProxyInterface;
