...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBusinessStartKetPackageClaimInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'mint', data: BytesLike): Result;
  ...
  export interface IBusinessStartKetPackageClaim extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBusinessStartKetPackageClaim;
    waitForDeployment(): Promise<this>;

    interface: IBusinessStartKetPackageClaimInterface;
