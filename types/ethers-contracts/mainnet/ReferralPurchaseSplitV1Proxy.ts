...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface ReferralPurchaseSplitV1ProxyInterface extends Interface {
  ...
  export interface ReferralPurchaseSplitV1Proxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): ReferralPurchaseSplitV1Proxy;
    waitForDeployment(): Promise<this>;

    interface: ReferralPurchaseSplitV1ProxyInterface;
