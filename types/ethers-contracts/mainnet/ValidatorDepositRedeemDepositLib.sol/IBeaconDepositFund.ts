...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeaconDepositFundInterface extends Interface {
  ...
  export interface IBeaconDepositFund extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeaconDepositFund;
    waitForDeployment(): Promise<this>;

    interface: IBeaconDepositFundInterface;
