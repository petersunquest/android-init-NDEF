...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface BeamioUserCardUpgradeableBeaconInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'upgradeTo', data: BytesLike): Result;
  ...
  export interface BeamioUserCardUpgradeableBeacon extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardUpgradeableBeacon;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardUpgradeableBeaconInterface;
