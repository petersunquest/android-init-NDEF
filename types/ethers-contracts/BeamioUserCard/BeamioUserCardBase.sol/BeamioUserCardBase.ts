...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
  ...
  export interface BeamioUserCardBase extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardBase;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardBaseInterface;
