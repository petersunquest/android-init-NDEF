...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ICardPointsBalanceInterface extends Interface {
  ...
  export interface ICardPointsBalance extends BaseContract {
    
    connect(runner?: ContractRunner | null): ICardPointsBalance;
    waitForDeployment(): Promise<this>;

    interface: ICardPointsBalanceInterface;
