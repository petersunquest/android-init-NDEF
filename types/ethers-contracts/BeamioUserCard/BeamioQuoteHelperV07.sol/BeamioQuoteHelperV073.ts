...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioQuoteHelperV073Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface BeamioQuoteHelperV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioQuoteHelperV073;
    waitForDeployment(): Promise<this>;

    interface: BeamioQuoteHelperV073Interface;
