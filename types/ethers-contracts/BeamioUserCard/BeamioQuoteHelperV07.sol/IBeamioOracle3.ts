...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioOracle3Interface extends Interface {
  ...
  export interface IBeamioOracle3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioOracle3;
    waitForDeployment(): Promise<this>;

    interface: IBeamioOracle3Interface;
