...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ICardPointsInterface extends Interface {
  ...
  export interface ICardPoints extends BaseContract {
    
    connect(runner?: ContractRunner | null): ICardPoints;
    waitForDeployment(): Promise<this>;

    interface: ICardPointsInterface;
