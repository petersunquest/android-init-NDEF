...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IFactoryOracleQuoteInterface extends Interface {
  ...
  export interface IFactoryOracleQuote extends BaseContract {
    
    connect(runner?: ContractRunner | null): IFactoryOracleQuote;
    waitForDeployment(): Promise<this>;

    interface: IFactoryOracleQuoteInterface;
