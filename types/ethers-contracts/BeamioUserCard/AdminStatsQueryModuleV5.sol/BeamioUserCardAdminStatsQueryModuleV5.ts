...
encodeFunctionData(functionFragment: 'clearMembershipFeePurchase', values: [AddressLike]): string;
...
encodeFunctionData(functionFragment: 'membershipFeeDurationKind', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'membershipFeeE6', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'membershipFeeMode', values?: undefined): string;
encodeFunctionData(functionFragment: 'membershipFeePending', values: [AddressLike]): string;
...
encodeFunctionData(functionFragment: 'setMembershipFees', values: [BigNumberish[], BigNumberish[]]): string;
...
decodeFunctionResult(functionFragment: 'clearMembershipFeePurchase', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'membershipFeeDurationKind', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'membershipFeeE6', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'membershipFeeMode', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'membershipFeePending', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'setMembershipFees', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'stageMembershipFeePurchase', data: BytesLike): Result;
  ...
  export interface BeamioUserCardAdminStatsQueryModuleV5 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardAdminStatsQueryModuleV5;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardAdminStatsQueryModuleV5Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    clearMembershipFeePurchase: TypedContractMethod<
      [user: AddressLike, ],
      [void],
      'nonpayable'
    >
    ...
    membershipFeeDurationKind: TypedContractMethod<
    ...
    membershipFeeE6: TypedContractMethod<
      [tierIndex: BigNumberish, ],
      [bigint],
      'view'
    >
    ...
    membershipFeePending: TypedContractMethod<
      [user: AddressLike, ],
      [[bigint, bigint, bigint, bigint, boolean] & {tierIndex: bigint, feePaid6: bigint, pointsCredit6: bigint, deadline: bigint, active: boolean }],
      'view'
    >
    ...
    setMembershipFees: TypedContractMethod<
      [feeE6: BigNumberish[], durationKind: BigNumberish[], ],
      [void],
      'nonpayable'
    >
    ...
    stageMembershipFeePurchase: TypedContractMethod<
...
getFunction(nameOrSignature: 'bindShareRefereeWithSignature'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'clearMembershipFeePurchase'): TypedContractMethod<
      [user: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'getGlobalStatsFull'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'membershipFeeDurationKind'): TypedContractMethod<
      [tierIndex: BigNumberish, ],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'membershipFeeE6'): TypedContractMethod<
      [tierIndex: BigNumberish, ],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'membershipFeeMode'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'membershipFeePending'): TypedContractMethod<
      [user: AddressLike, ],
      [[bigint, bigint, bigint, bigint, boolean] & {tierIndex: bigint, feePaid6: bigint, pointsCredit6: bigint, deadline: bigint, active: boolean }],
      'view'
    >;
...
getFunction(nameOrSignature: 'selectorModuleKind'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'setMembershipFees'): TypedContractMethod<
      [feeE6: BigNumberish[], durationKind: BigNumberish[], ],
      [void],
      'nonpayable'
    >;
