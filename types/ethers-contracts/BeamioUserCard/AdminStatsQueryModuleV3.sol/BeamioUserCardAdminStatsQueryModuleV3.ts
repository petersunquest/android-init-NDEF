...
export declare namespace BeamioUserCardAdminStatsQueryModuleV1 {
  ...
  export interface BeamioUserCardAdminStatsQueryModuleV3Interface extends Interface {
    getFunction(nameOrSignature: "getAdminAirdropLimit" | "getAdminAndSubordinateLimits" | "getAdminAndSubordinateLimitsPage" | "getAdminBurnCounter" | "getAdminHourlyData" | "getAdminListWithMetadata" | "getAdminMintCounter" | "getAdminPeriodReports" | "getAdminRedeemMintCounter" | "getAdminStatsFull" | "getAdminSubordinatesWithMetadata" | "getAdminTransferAmountCounter" | "getAdminTransferCounter" | "getAdminUSDCMintCounter" | "getGlobalAdminToAdminCounters" | "getGlobalAdminToAdminHourlyData" | "getGlobalStatsFull" | "selectorModuleKind" | "userHasAnyProgramAsset"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'userHasAnyProgramAsset', values: [AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'userHasAnyProgramAsset', data: BytesLike): Result;
  }

  

  export interface BeamioUserCardAdminStatsQueryModuleV3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardAdminStatsQueryModuleV3;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardAdminStatsQueryModuleV3Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    userHasAnyProgramAsset: TypedContractMethod<
      [userEOA: AddressLike, ],
      [boolean],
      'view'
    >
...
getFunction(nameOrSignature: 'selectorModuleKind'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'userHasAnyProgramAsset'): TypedContractMethod<
      [userEOA: AddressLike, ],
      [boolean],
      'view'
    >;
