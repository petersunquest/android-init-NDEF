...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface BeamioUserCardBeaconProxyInterface extends Interface {
  ...
  export interface BeamioUserCardBeaconProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardBeaconProxy;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardBeaconProxyInterface;
