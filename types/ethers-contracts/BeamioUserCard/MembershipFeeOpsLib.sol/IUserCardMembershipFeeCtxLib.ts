...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IUserCardMembershipFeeCtxLibInterface extends Interface {
    getFunction(nameOrSignature: "factoryGateway" | "owner" | "tiers"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'tiers', data: BytesLike): Result;
  ...
  export interface IUserCardMembershipFeeCtxLib extends BaseContract {
    
    connect(runner?: ContractRunner | null): IUserCardMembershipFeeCtxLib;
    waitForDeployment(): Promise<this>;

    interface: IUserCardMembershipFeeCtxLibInterface;
