...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioAccountFactoryResolveAaV4Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'isBeamioAccount', data: BytesLike): Result;
  ...
  export interface IBeamioAccountFactoryResolveAaV4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioAccountFactoryResolveAaV4;
    waitForDeployment(): Promise<this>;

    interface: IBeamioAccountFactoryResolveAaV4Interface;
