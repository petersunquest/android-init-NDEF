...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioRedeemModuleVNext3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'terminateRedeemPool', data: BytesLike): Result;
  ...
  export interface IBeamioRedeemModuleVNext3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioRedeemModuleVNext3;
    waitForDeployment(): Promise<this>;

    interface: IBeamioRedeemModuleVNext3Interface;
