...
export declare namespace BeamioUserCard {
  ...
  export interface BeamioUserCard3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
  ...
  export interface BeamioUserCard3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCard3;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCard3Interface;
