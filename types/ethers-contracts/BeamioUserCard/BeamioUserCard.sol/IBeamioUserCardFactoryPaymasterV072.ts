...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioUserCardFactoryPaymasterV072Interface extends Interface {
  ...
  export interface IBeamioUserCardFactoryPaymasterV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioUserCardFactoryPaymasterV072;
    waitForDeployment(): Promise<this>;

    interface: IBeamioUserCardFactoryPaymasterV072Interface;
