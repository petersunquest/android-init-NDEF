...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IGatewayMintFactoryChargeRewardInterface extends Interface {
    getFunction(nameOrSignature: "defaultChargeRewardModule"): FunctionFragment;
  ...
  export interface IGatewayMintFactoryChargeReward extends BaseContract {
    
    connect(runner?: ContractRunner | null): IGatewayMintFactoryChargeReward;
    waitForDeployment(): Promise<this>;

    interface: IGatewayMintFactoryChargeRewardInterface;
