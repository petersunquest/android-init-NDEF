...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IGatewayMintCardFactoryGwInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'owner', data: BytesLike): Result;
  ...
  export interface IGatewayMintCardFactoryGw extends BaseContract {
    
    connect(runner?: ContractRunner | null): IGatewayMintCardFactoryGw;
    waitForDeployment(): Promise<this>;

    interface: IGatewayMintCardFactoryGwInterface;
