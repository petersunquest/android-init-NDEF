...
export declare namespace BeamioUserCardAdminStatsQueryModuleV1 {
  ...
  export interface BeamioUserCardAdminStatsQueryModuleV2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'selectorModuleKind', data: BytesLike): Result;
  ...
  export interface BeamioUserCardAdminStatsQueryModuleV2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardAdminStatsQueryModuleV2;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardAdminStatsQueryModuleV2Interface;
