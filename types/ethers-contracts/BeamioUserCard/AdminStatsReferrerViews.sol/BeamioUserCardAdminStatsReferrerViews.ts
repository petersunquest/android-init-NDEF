...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioUserCardAdminStatsReferrerViewsInterface extends Interface {
    getFunction(nameOrSignature: "getRefereesByReferrerPage" | "getReferrerRefereeLedger" | "getReferrersPage" | "getRegisteredRefereesPage" | "refereeChargePointsTotal6" | "refereeCountByReferrer" | "refereeReferrer" | "referrerTotalCount" | "registeredRefereeTotalCount"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'registeredRefereeTotalCount', data: BytesLike): Result;
  ...
  export interface BeamioUserCardAdminStatsReferrerViews extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardAdminStatsReferrerViews;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardAdminStatsReferrerViewsInterface;
