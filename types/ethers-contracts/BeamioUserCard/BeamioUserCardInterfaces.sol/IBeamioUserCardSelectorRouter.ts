...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioUserCardSelectorRouterInterface extends Interface {
  ...
  export interface IBeamioUserCardSelectorRouter extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioUserCardSelectorRouter;
    waitForDeployment(): Promise<this>;

    interface: IBeamioUserCardSelectorRouterInterface;
