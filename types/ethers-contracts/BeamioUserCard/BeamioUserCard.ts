...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
    ...
    export type UserCardTierStruct = {minUsdc6: BigNumberish, attr: BigNumberish, tierExpirySeconds: BigNumberish, upgradeByBalance: boolean}

    export type UserCardTierStructOutput = [minUsdc6: bigint, attr: bigint, tierExpirySeconds: bigint, upgradeByBalance: boolean] & {minUsdc6: bigint, attr: bigint, tierExpirySeconds: bigint, upgradeByBalance: boolean }
...
encodeFunctionData(functionFragment: 'appendTier(uint256,uint256,uint256)', values: [BigNumberish, BigNumberish, BigNumberish]): string;
encodeFunctionData(functionFragment: 'appendTier(uint256,uint256,uint256,bool)', values: [BigNumberish, BigNumberish, BigNumberish, boolean]): string;
...
encodeFunctionData(functionFragment: 'initialize', values: [string, BigNumberish, BigNumberish, AddressLike, AddressLike, BytesLike]): string;
...
encodeFunctionData(functionFragment: 'setTiers', values: [UserCardTierStruct[]]): string;
...
decodeFunctionResult(functionFragment: 'appendTier(uint256,uint256,uint256)', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'appendTier(uint256,uint256,uint256,bool)', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
    ...
    export namespace ReferrerRefereeRewardLedgeredEvent {
      export type InputTuple = [referrer: AddressLike, referee: AddressLike, kind: BigNumberish, amountFiat6: BigNumberish, reward13E6: BigNumberish];
      export type OutputTuple = [referrer: string, referee: string, kind: bigint, amountFiat6: bigint, reward13E6: bigint];
      export interface OutputObject {referrer: string, referee: string, kind: bigint, amountFiat6: bigint, reward13E6: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    "appendTier(uint256,uint256,uint256)": TypedContractMethod<
    ...
    "appendTier(uint256,uint256,uint256,bool)": TypedContractMethod<
    ...
    initialize: TypedContractMethod<
      [uri_: string, currency_: BigNumberish, pointsUnitPriceInCurrencyE6_: BigNumberish, initialOwner: AddressLike, gateway_: AddressLike, initialTierConfig_: BytesLike, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'adminParent'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'appendTier(uint256,uint256,uint256)'): TypedContractMethod<
      [minUsdc6: BigNumberish, attr: BigNumberish, tierExpirySeconds: BigNumberish, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'appendTier(uint256,uint256,uint256,bool)'): TypedContractMethod<
      [minUsdc6: BigNumberish, attr: BigNumberish, tierExpirySeconds: BigNumberish, upgradeByBalance: boolean, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'ReferrerRefereeRewardLedgered'): TypedContractEvent<ReferrerRefereeRewardLedgeredEvent.InputTuple, ReferrerRefereeRewardLedgeredEvent.OutputTuple, ReferrerRefereeRewardLedgeredEvent.OutputObject>;
...
getEvent(key: 'URI'): TypedContractEvent<URIEvent.InputTuple, URIEvent.OutputTuple, URIEvent.OutputObject>;
    ...
    filters: {
      ...
      'ReferrerRefereeRewardLedgered(address,address,uint8,uint256,uint256)': TypedContractEvent<ReferrerRefereeRewardLedgeredEvent.InputTuple, ReferrerRefereeRewardLedgeredEvent.OutputTuple, ReferrerRefereeRewardLedgeredEvent.OutputObject>;
      ReferrerRefereeRewardLedgered: TypedContractEvent<ReferrerRefereeRewardLedgeredEvent.InputTuple, ReferrerRefereeRewardLedgeredEvent.OutputTuple, ReferrerRefereeRewardLedgeredEvent.OutputObject>;
