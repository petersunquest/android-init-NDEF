...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioAccountFactoryV073Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'isBeamioAccount', data: BytesLike): Result;
  ...
  export interface IBeamioAccountFactoryV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioAccountFactoryV073;
    waitForDeployment(): Promise<this>;

    interface: IBeamioAccountFactoryV073Interface;
