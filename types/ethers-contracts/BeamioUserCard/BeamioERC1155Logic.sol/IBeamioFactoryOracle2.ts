...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioFactoryOracle2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioFactoryOracle2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioFactoryOracle2;
    waitForDeployment(): Promise<this>;

    interface: IBeamioFactoryOracle2Interface;
