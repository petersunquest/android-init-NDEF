...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IRedeemModule3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'createRedeem', data: BytesLike): Result;
  ...
  export interface IRedeemModule3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IRedeemModule3;
    waitForDeployment(): Promise<this>;

    interface: IRedeemModule3Interface;
