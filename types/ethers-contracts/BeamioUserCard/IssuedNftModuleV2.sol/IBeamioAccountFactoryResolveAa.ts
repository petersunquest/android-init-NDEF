...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioAccountFactoryResolveAaInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'isBeamioAccount', data: BytesLike): Result;
  ...
  export interface IBeamioAccountFactoryResolveAa extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioAccountFactoryResolveAa;
    waitForDeployment(): Promise<this>;

    interface: IBeamioAccountFactoryResolveAaInterface;
