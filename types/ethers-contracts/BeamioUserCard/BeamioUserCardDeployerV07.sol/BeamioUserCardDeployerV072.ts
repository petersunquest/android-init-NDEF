...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioUserCardDeployerV072Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwner', data: BytesLike): Result;
  ...
  export interface BeamioUserCardDeployerV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardDeployerV072;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardDeployerV072Interface;
