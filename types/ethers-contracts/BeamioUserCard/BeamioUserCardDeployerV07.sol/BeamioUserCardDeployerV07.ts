...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioUserCardDeployerV07Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwner', data: BytesLike): Result;
  ...
  export interface BeamioUserCardDeployerV07 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardDeployerV07;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardDeployerV07Interface;
