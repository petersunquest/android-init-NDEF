...
decodeFunctionResult(functionFragment: 'usedOwnerExecuteNonces', data: BytesLike): Result;
  ...
  export interface BeamioUserCardFactoryPaymasterV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioUserCardFactoryPaymasterV073;
    waitForDeployment(): Promise<this>;

    interface: BeamioUserCardFactoryPaymasterV073Interface;
