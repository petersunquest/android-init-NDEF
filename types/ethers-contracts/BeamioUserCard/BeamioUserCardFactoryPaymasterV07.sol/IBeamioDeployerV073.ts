...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioDeployerV073Interface extends Interface {
  ...
  export interface IBeamioDeployerV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioDeployerV073;
    waitForDeployment(): Promise<this>;

    interface: IBeamioDeployerV073Interface;
