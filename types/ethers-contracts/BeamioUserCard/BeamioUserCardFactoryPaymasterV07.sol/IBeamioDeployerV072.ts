...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioDeployerV072Interface extends Interface {
  ...
  export interface IBeamioDeployerV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioDeployerV072;
    waitForDeployment(): Promise<this>;

    interface: IBeamioDeployerV072Interface;
