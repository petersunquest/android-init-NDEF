...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioQuoteHelper2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioQuoteHelper2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioQuoteHelper2;
    waitForDeployment(): Promise<this>;

    interface: IBeamioQuoteHelper2Interface;
