...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IERC1155BalanceViewInterface extends Interface {
  ...
  export interface IERC1155BalanceView extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC1155BalanceView;
    waitForDeployment(): Promise<this>;

    interface: IERC1155BalanceViewInterface;
