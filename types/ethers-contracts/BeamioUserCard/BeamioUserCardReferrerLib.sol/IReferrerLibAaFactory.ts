...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IReferrerLibAaFactoryInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'isBeamioAccount', data: BytesLike): Result;
  ...
  export interface IReferrerLibAaFactory extends BaseContract {
    
    connect(runner?: ContractRunner | null): IReferrerLibAaFactory;
    waitForDeployment(): Promise<this>;

    interface: IReferrerLibAaFactoryInterface;
