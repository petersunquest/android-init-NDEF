...
decodeFunctionResult(functionFragment: 'withdrawTo', data: BytesLike): Result;
  ...
  export interface BeamioFactoryPaymasterV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioFactoryPaymasterV072;
    waitForDeployment(): Promise<this>;

    interface: BeamioFactoryPaymasterV072Interface;
