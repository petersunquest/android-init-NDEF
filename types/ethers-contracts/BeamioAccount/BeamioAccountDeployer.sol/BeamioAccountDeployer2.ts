...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioAccountDeployer2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'setFactory', data: BytesLike): Result;
  ...
  export interface BeamioAccountDeployer2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioAccountDeployer2;
    waitForDeployment(): Promise<this>;

    interface: BeamioAccountDeployer2Interface;
