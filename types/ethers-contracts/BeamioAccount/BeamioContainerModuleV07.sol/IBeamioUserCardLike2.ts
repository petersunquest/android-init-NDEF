...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioUserCardLike2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'pointsUnitPriceInCurrencyE6', data: BytesLike): Result;
  ...
  export interface IBeamioUserCardLike2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioUserCardLike2;
    waitForDeployment(): Promise<this>;

    interface: IBeamioUserCardLike2Interface;
