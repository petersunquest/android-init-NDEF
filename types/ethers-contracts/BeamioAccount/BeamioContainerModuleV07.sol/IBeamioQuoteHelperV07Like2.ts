...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioQuoteHelperV07Like2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioQuoteHelperV07Like2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioQuoteHelperV07Like2;
    waitForDeployment(): Promise<this>;

    interface: IBeamioQuoteHelperV07Like2Interface;
