...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IPaymasterV072Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'validatePaymasterUserOp', data: BytesLike): Result;
  ...
  export interface IPaymasterV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IPaymasterV072;
    waitForDeployment(): Promise<this>;

    interface: IPaymasterV072Interface;
