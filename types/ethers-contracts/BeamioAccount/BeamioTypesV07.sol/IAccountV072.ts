...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IAccountV072Interface extends Interface {
  ...
  export interface IAccountV072 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IAccountV072;
    waitForDeployment(): Promise<this>;

    interface: IAccountV072Interface;
