...
async function main() {
  ...
  console.log("\nPeer bridge keys (voteMintFromPeerDeposit):");
  console.log("  wCNET:   peerChainId=", CONET_CHAIN_ID.toString(), "peerToken=", NATIVE_PEER_TOKEN);
  console.log("  B-Units: peerToken=", BUINT_PEER_TOKEN, "(peerChainId = 源链 burn 所在 chainId)");
  console.log("  GB:      peerToken=", GB_PEER_TOKEN, "(amount = amountGB18)");
