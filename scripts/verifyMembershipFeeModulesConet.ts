...
const TARGETS: Target[] = [
	{
		key: 'MembershipFeeOpsLib',
		address: snap.membershipFeeOpsLib,
		fullRel: 'deployments/base-MembershipFeeOpsLib-standard-input-FULL.json',
		sourceKey: 'project/src/BeamioUserCard/MembershipFeeOpsLib.sol',
		contractName: 'project/src/BeamioUserCard/MembershipFeeOpsLib.sol:MembershipFeeOpsLib',
	},
	{
		key: 'MembershipStatsModule',
		address: snap.membershipStatsModule,
		fullRel: 'deployments/base-MembershipStatsModule-standard-input-FULL.json',
	...
	},
	{
		...
		contractName:
			'project/src/BeamioUserCard/AdminStatsQueryModuleV5.sol:BeamioUserCardAdminStatsQueryModuleV5',
		libraries: {
