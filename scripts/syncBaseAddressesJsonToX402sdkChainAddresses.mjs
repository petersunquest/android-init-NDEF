...
const OPTIONAL = [
  ...
  [
    ...
    "BEAMIO_USER_CARD_ADMIN_GATEWAY_LIB",
    /export const BASE_BEAMIO_USER_CARD_ADMIN_GATEWAY_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_FAUCET_GATEWAY_LIB",
    "BEAMIO_USER_CARD_FAUCET_GATEWAY_LIB",
    /export const BASE_BEAMIO_USER_CARD_FAUCET_GATEWAY_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_GATEWAY_MINT_LIB",
    "BEAMIO_USER_CARD_GATEWAY_MINT_LIB",
    /export const BASE_BEAMIO_USER_CARD_GATEWAY_MINT_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_GOVERNANCE_LIB",
    "BEAMIO_USER_CARD_GOVERNANCE_LIB",
    /export const BASE_BEAMIO_USER_CARD_GOVERNANCE_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_ISSUED_NFT_GATEWAY_LIB",
    "BEAMIO_USER_CARD_ISSUED_NFT_GATEWAY_LIB",
    /export const BASE_BEAMIO_USER_CARD_ISSUED_NFT_GATEWAY_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_MODULE_ROUTER_LIB",
    "BEAMIO_USER_CARD_MODULE_ROUTER_LIB",
    /export const BASE_BEAMIO_USER_CARD_MODULE_ROUTER_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_REDEEM_GATEWAY_LIB",
    "BEAMIO_USER_CARD_REDEEM_GATEWAY_LIB",
    /export const BASE_BEAMIO_USER_CARD_REDEEM_GATEWAY_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_REFERRER_LIB",
    "BEAMIO_USER_CARD_REFERRER_LIB",
    /export const BASE_BEAMIO_USER_CARD_REFERRER_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_UPDATE_LIB",
    "BEAMIO_USER_CARD_UPDATE_LIB",
    /export const BASE_BEAMIO_USER_CARD_UPDATE_LIB = '[^']*'/,
  ],
  [
    "BASE_BEAMIO_USER_CARD_VIEWS_LIB",
    "BEAMIO_USER_CARD_VIEWS_LIB",
    /export const BASE_BEAMIO_USER_CARD_VIEWS_LIB = '[^']*'/,
  ],
];
