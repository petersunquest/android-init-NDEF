#!/bin/bash
# Set execution-layer fee_recipient → ConetLabMiningPool for all validators on 74.208.224.45.
# Beacon runs locally on 74 (:4000); only restarts Prysm validator — not geth/beacon.
#
# Run ON 74.208.224.45:
#   FEE_RECIPIENT=0x32bE583C8e778FFfC5107BF34820c2B225336201 \
#   BEACON_RPC_PROVIDER=127.0.0.1:4000 \
#     bash setConetLabMiningPoolFeeRecipient74.sh
