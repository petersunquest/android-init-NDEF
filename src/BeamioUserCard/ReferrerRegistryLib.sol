...
library ReferrerRegistryLib {
    ...
    function onRegisterReferee(ReferrerStorage.Layout storage r, address refereeAA) external {
    ...
    function onSetRefereeReferrer(ReferrerStorage.Layout storage r, address refereeAA, address referrerAA) external {
