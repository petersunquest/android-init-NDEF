...
| --- | --- | --- | --- |
| [DLE Mock-L1 拍卖撮合 MVP](./dle-mock-l1-auction-mvp-2026-08.md) | 无独立交互 Canvas | **2026-08-21：Round 1–10 已落地（+ e2e/demo recovery 模式；一键 shell 先 unlist 回收再 settle）；非主网 / 非生产 RANDAO·DePIN** | EventIngress + certificate + 1bps 50/50；Archive RPC custody + `list`/`unlist`/`approve`/`preflight`/`settle`；Explorer Unlist / Mark failed / Cancel + Preflight + List→Approve→Settle；旁路 lab `notL1Nft` |
