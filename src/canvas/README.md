...
| --- | --- | --- | --- |
| [conet-l0d crate MVP 验收 + P1 encrypt+POST](./conet-l0d-mvp-accept-p1-2026-08.md) | `conet-l0d-mvp-accept-p1.canvas.tsx` | **2026-08-17 21:50Z：crate MVP 已验收；P1 出站 + 入站解密/TUN 写回已在 crate；未打开现役 mailbox SSE；实验室 `[l0]` 关；`.98` geth 已恢复** | 两机公网 P2P 现场数；可通过 vs 不得声称；P1 复用现役 `/post`；禁 vIP advertise |
