...
| --- | --- | --- | --- |
| [DLE Mock-L1 拍卖撮合 MVP](./dle-mock-l1-auction-mvp-2026-08.md) | 无独立交互 Canvas | **2026-08-21：Round 1–5 已落地（custody / demo / 真上链 settle / e2e / Explorer list+settle CTA）；非主网 / 非生产 RANDAO·DePIN** | EventIngress + certificate + 1bps 50/50；Archive RPC custody + `list`/`settle`；Explorer 触发 list escrow 与 Archive settle；旁路 lab `notL1Nft` |
