...
| --- | --- | --- | --- |
| [DLE Mock-L1 拍卖撮合 MVP](./dle-mock-l1-auction-mvp-2026-08.md) | 无独立交互 Canvas | **2026-08-20：Round 1–3 已落地（custody / demo / 真上链 settle / e2e）；非主网 / 非生产 RANDAO·DePIN** | EventIngress + certificate + 1bps 50/50；Archive RPC custody + `MockDleAuctionSettlement.settle`；旁路 lab `notL1Nft` |
