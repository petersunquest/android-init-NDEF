...
| --- | --- | --- | --- |
| [DLE Mock-L1 拍卖撮合 MVP](./dle-mock-l1-auction-mvp-2026-08.md) | 无独立交互 Canvas | **2026-08-21：Round 1–6 已落地（custody / list / approve / settle / e2e / Explorer CTA）；非主网 / 非生产 RANDAO·DePIN** | EventIngress + certificate + 1bps 50/50；Archive RPC custody + `list`/`approve`/`settle`；Explorer 触发 escrow list、quote approve 与 Archive settle；旁路 lab `notL1Nft` |
