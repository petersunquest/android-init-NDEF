...
- 下一阶段建设序：`dle-mvp-p12-milestones-2026-08.md`（**P12–P25 已落地**；`runtime:test` 154/154；`explorer:test` 8/8；公开 SPA `index-DaEv6psZ.js` 已发；下一闸停放 / 仅审查；不得开 `pilotStartedAt`；不得发明 P26）。
