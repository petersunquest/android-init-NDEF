...
- 公开 Explorer：`https://dle.conet.network/`（Clusters = 2；绿点只认 `seatingQualified`；P25 SPA `index-U1o9ul_I.js` 已发，2026-08-18T00:18:49Z）
...
- P25 已落地：Explorer 只读非绿 overlay；绿点未改；公开 SPA `index-U1o9ul_I.js` 已发（线上 ready 仍 false / count=1）
...
- [x] P25 公开 SPA 发到 `dle.conet.network`（`index-U1o9ul_I.js`；线上 ready 仍 false）
- [ ] 30 天资格（明确未宣称）
